...
{
	private static String base_URL = "http://119.29.104.108:80/";		//Default configuration for WAMP - 80 is default port for WAMP and 10.0.2.2 is localhost IP in Android Emulator
	// Server user login url
	public static String URL_LOGIN = base_URL+"image_protect/";

	// Server user register url
	public static String URL_REGISTER = base_URL+"image_protect/";
/*
